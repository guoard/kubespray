...
- Core
  - [kubernetes](https://github.com/kubernetes/kubernetes) 1.35.9
  - [etcd](https://github.com/etcd-io/etcd) 3.6.15
  - [docker](https://www.docker.com/) 28.3
  - [containerd](https://containerd.io/) 2.2.8
  - [cri-o](http://cri-o.io/) 1.35.9 (experimental: see [CRI-O Note](docs/CRI/cri-o.md). Only on fedora, ubuntu and centos based OS)
- Network Plugin
